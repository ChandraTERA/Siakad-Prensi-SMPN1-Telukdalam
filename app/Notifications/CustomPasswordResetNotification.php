...
class CustomPasswordResetNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Reset Password - SIAKAD School Management System')
            ->greeting('Hello!')
            ->line('We received a request to reset your password for your SIAKAD account.')
            ...
            ->salutation('Best regards, SIAKAD Team');
    }
