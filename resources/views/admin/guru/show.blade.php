...
@section('page-description', 'Informasi lengkap mengenai data guru')

@section('content')
    <!-- Breadcrumb & Actions -->
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div class="flex items-center space-x-2 text-sm text-gray-600">
            <a href="{{ route('admin.guru.index') }}" class="hover:text-blue-600 transition-colors duration-200">Data Guru</a>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="text-center">
                    ...
                    <!-- Basic Info -->
                    <div class="mt-6">
                        <h2 class="text-2xl font-bold text-gray-900">{{ $guru->user->name }}</h2>
                        <p class="text-gray-600 mt-1">{{ $guru->user->email }}</p>
                        <div class="mt-4">
                            <span
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-gray-900 font-medium">{{ $guru->user->name }}</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-500">Email</label>
                            <p class="text-gray-900">{{ $guru->user->email }}</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-500">NIP</label>
                            <p class="text-gray-900 font-mono">{{ $guru->nip ?? '-' }}</p>
                        </div>
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-gray-900">{{ $guru->no_telepon ?? '-' }}</p>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-gray-900">{{ $guru->user->created_at->format('d F Y') }}</p>
                        </div>
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-500">Terakhir Update</label>
                            <p class="text-gray-900">{{ $guru->updated_at->format('d F Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            <label class="text-sm font-medium text-gray-500">Jumlah Kelas Diampu</label>
                            <div class="flex items-center">
                                <span class="text-2xl font-bold text-gray-400">0</span>
                                <span class="text-gray-500 ml-2">kelas</span>
                            </div>
                        </div>
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center">
                                <span class="text-2xl font-bold text-gray-400">0</span>
                                <span class="text-gray-500 ml-2">siswa</span>
                            </div>
                        </div>
                    </div>
                </div>
