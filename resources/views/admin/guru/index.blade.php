...
@section('page-description', 'Kelola data guru dan informasi terkait')
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $gurus->total() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Kelola data guru dan informasi terkait</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <!-- Search -->
                        <form method="GET" action="{{ route('admin.guru.index') }}" class="relative">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-sm text-blue-800">
                                Menampilkan {{ $gurus->count() }} dari {{ $gurus->total() }} guru untuk pencarian
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($gurus as $index => $user)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900 font-mono">{{ $user->guru->nip ?? '-' }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('admin.guru.show', $user->id) }}"
                                        ...
                                        <a href="{{ route('admin.guru.edit', $user->guru->id ?? $user->id) }}"
                                            class="text-indigo-600 hover:text-indigo-900 p-1 rounded transition-colors duration-200"
                                            title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <form action="{{ route('admin.guru.destroy', $user->guru->id ?? $user->id) }}"
                                            method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                                @click="isModalOpen = true; deleteUrl = '{{ route('admin.guru.destroy', $user->guru->id ?? $user->id) }}'"
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 text-lg font-medium">Belum ada data guru</p>
                                        <p class="text-gray-400 text-sm mt-1">Klik tombol "Tambah Guru" untuk menambahkan
                                            guru
                                            baru</p>
                                    </div>
                                </td>
        ...
        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div @click.away="isModalOpen = false" x-show="isModalOpen"
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-600 mt-2">Apakah Anda yakin ingin menghapus data guru ini? Tindakan ini tidak dapat
                        dibatalkan.</p>
